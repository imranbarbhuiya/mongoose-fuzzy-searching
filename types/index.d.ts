import { Callback, Document, DocumentQuery, FilterQuery, Model, Schema } from "mongoose";
...
export default function fuzzyPlugin<T>(schema: Schema<T>, options: MongooseFuzzyOptions<T>): void;
