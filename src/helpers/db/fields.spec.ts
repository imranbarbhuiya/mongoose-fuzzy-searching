...
describe("removeFuzzyElements", () => {
  it("should remove fuzzy fields", () => {
    const ret = {
      ...
      description_fuzzy: [
        { en_fuzzy: ["Descr in English"], it_fuzzy: ["Descr in Italian"] },
      ],
      firstName_fuzzy: ["Joe"],
      lastName_fuzzy: ["Doe"],
    };
...
describe("createNGrams", () => {
  it("should store ngrams to fuzzy attributes", () => {
    ...
    expect(attributes).toStrictEqual({
      ...
      text_fuzzy: [
        { title_fuzzy: ["My title"], description_fuzzy: ["My descr"] },
      ],
  ...
  it("should update empty attributes as empty array", () => {
    ...
    const fields: Fields = [
      ...
      {
        name: "text",
        keys: ["title", "description", "shortDescr", "notInialized"],
      },
